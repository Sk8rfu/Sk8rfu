...
## Bulgarian Version
# 👋 Здрасти, аз съм Sk8rfu

Аз съм разработчик, който се фокусира върху създаването на чисти, функционални и модерни уеб приложения.  
Работя по front‑end и back‑end проекти, Discord ботове и open‑source разработки.
